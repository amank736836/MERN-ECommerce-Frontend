const AboutVirtuoStore = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg text-gray-800 mt-12">
      ...
      <h2 className="text-3xl font-semibold mt-8 mb-4 text-gray-700">
        Who We Are
      </h2>
      <p className="mb-4 text-lg leading-relaxed">
      ...
      <h3 className="text-2xl font-medium mt-4 text-blue-500">Mission</h3>
      <p className="mb-4 text-lg leading-relaxed">
      ...
      <h3 className="text-2xl font-medium mt-4 text-blue-500">Vision</h3>
      <p className="mb-4 text-lg leading-relaxed">
      ...
      <ul className="list-disc list-inside mb-6 text-lg space-y-2">
        <li>
          <strong>Curated Fashion Selection:</strong> T-Shirts, Pants, and
          Shoes.
        </li>
        <li>
          <strong>Quality Assurance:</strong> Premium materials and
          craftsmanship.
        </li>
        <li>
          <strong>Affordable Pricing:</strong> Budget-friendly without
          compromising quality.
        </li>
        <li>
          <strong>Seamless Shopping Experience:</strong> Easy-to-use website
          with secure checkout.
        </li>
        <li>
          <strong>Fast & Reliable Shipping:</strong> Ensuring timely delivery.
        </li>
        <li>
          <strong>Hassle-Free Returns & Exchanges:</strong> Quick and easy
          process.
        </li>
        <li>
          <strong>Customer-Centric Approach:</strong> Dedicated support team.
        </li>
        <li>
          <strong>Eco-Friendly Fashion:</strong> Sustainable and ethical
          sourcing.
        </li>
      </ul>
      ...
      <p className="text-lg">
        <strong>Email:</strong>{" "}
        <a
          href="mailto:amankkarguwal@gmail.com"
